...
# In this program, i use my own heuristic and inmplement greedy search.
# In this heuristic, i have considered the manhattan distance for both,
# 1. distance between robot and nearest block
# 2. distance between blocks and nearest storage
# The sum of these two distances is considered as a heuristic to explore the state in the queue.
# The state of board where the above sum is least is explored first.
# The queue is sorted each time new states are explored
...
print 'Solution using greedy-best search'
