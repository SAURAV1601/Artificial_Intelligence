...
#function to calculate manhattan distance between 2 cells
...
print 'Finding solution for the board using Manhattan Distance Heuristic'
...
while(len(d)>0):
	...
	# the sum of Manhattan distances between each box that has yet to be stored and the storage nearest to it
	# Uncomment following lines to print the manhattan distance for each state in the queue
	# print distancearray
	# sorting queue using manhattan distance ascending order
	distancearray.sort()
